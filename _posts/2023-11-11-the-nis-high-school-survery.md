...
有专门的网站入口。并不是这些国家，地区的全部大学都是通过这个入口进行申请。
...
美制高中，没有统一的考试和测评，各个学校根据学校的情况，选择不同的测试标准。

比较常见的测试标准就是MAP

美制高中的MAP测试（Measures of Academic Progress）是由美国西北测评协会（NWEA）开发的一套基于计算机的自适应学业测试。MAP测试适用于K-12年级的学生，MAP测试分四科，内容覆盖阅读、语言运用、数学和科学四门学科，每科考试时间大约一小时。

MAP测试的特点是：

* 自适应：MAP测试会根据学生的回答情况，调整后续的题目难度，确保学生能够得到适合自己水平的测试。
* 多维度：MAP测试不仅考察学生的知识掌握程度，还考察学生的理解能力、应用能力和思维能力。
* 常模：MAP测试拥有庞大的常模数据库，可以帮助学生与其他学生进行比较，了解自己的学业水平。

MAP测试的用途主要有以下几种：

* 学业评估：MAP测试可以帮助学校和教师了解学生的学业水平，并制定针对性的教学计划。
* 入学评估：MAP测试可以作为学生升学申请的参考材料。
* 学业规划：MAP测试可以帮助学生了解自己的学业优势和劣势，制定合理的学业规划。

MAP测试每年会在美国举行三次，每次测试的考试时间约为1小时。测试结果会在考后24小时内生成，并提供给学校和学生。

MAP测试是美制高中非常重要的学业评估工具，可以帮助学生更好地学习和发展。

学校要采用MAP测试，需要通过美国西北测评协会（NWEA）评估，才能使用MAP进行测试。
...
NIS的学生的MAP成绩，整体来说，还是不错的，超过美国学生的平均水平。我孩子参加了2次的MAP测试，整体感觉，测试结果还是非常符合现实的情况。
