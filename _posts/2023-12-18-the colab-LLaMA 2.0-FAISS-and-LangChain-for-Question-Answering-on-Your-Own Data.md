---
layout:     post
title:      LLaMA 2.0, FAISS and LangChain for Question-Answering on Your Own Data
...
大家在Huggingface上看到的版本，Llama2和Llama2-chat的6个版本，是Meta发布的，你需要使用相同的邮箱申请Meta和Huggingface的账号，通过审批后，可以看到访问。

Llama2-hf和Llama2-hf，是Huggingface和Meta合作，加上Huggingface的Transformers，发布了Llama2-hf和Llama2-hf版本，适合开发者对模型进行微调。

使用工具，就可以实现从Llama的原始模型，转换成HF模型，Meta已经帮大家转换好的，直接使用就可以。
...
## Import All the Required Libraries
	...
	# hf_auth = 'hf_SFVATnoGtfsnyyZVwbSLyKTXR'
